...
account.addPurchase(EndOfLineDecorator(purchase: BlackFridayDecorator(purchase: GiftOptionDecorator(purchase: Purchase.init(product: "Sunglasses", price: 25), options: GiftOptionDecorator.OPTION.giftwrap, GiftOptionDecorator.OPTION.delivery))))
